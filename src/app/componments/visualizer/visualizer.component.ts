...
import {
  IVisualizerContextService, VISUALIZER_CONTEXT
...
import {
  selectCurrentSolution, selectSolutions
...
import {
  AfterViewInit, Component, Inject, OnDestroy, OnInit, ViewChild, ViewContainerRef
} from '@angular/core';
...
} from '../dialog/no-solution-dialog/no-solution-dialog.component';
import {
  SceneVisualizationComponent
} from '../scene-visualization/scene-visualization.component';
