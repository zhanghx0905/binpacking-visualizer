...
export class SolutionValidationComponent {
  public currentSolutionValidation$ = this._solutionStore.select(
    selectCurrentSolutionValidation
  );

  constructor(
    @Inject(VISUALIZER_CONTEXT)
    private _visualizerComponentService: IVisualizerContextService,
